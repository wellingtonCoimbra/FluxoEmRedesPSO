...
public class SistemaHidroeletricoFioDagua {
...
//	}
	...
	public void volumefinal(NoHidroenergetico[] NosIntervaloAtual){
...
//				nosIntervaloAtual[i].setVazaoDefluente(vazaoDefluente);
	...
	public double Executar(int intervalo,double alfa,double Tolerancia,double Demanda,
			NoHidroenergetico[] nosIntervaloAtual,NoHidroenergetico[] nosIntervaloanterior,double EASmax,IntervaloDeHorizonte intervaloHorizonte){
