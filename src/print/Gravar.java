...
public class Gravar {
	...
	public void gravarValores(SimulacaoOperacaoEnergetica sistema, int intervalos, int numUsina) throws IOException {
		arq = new FileWriter("c:\\Users\\Wellington\\Desktop\\Dados teste Simulação hidreletrica\\1936-1941_fio_dagua.txt");
		...
		// gravarValorAgua(sistema, intervalos, numUsina);
		...
		gravarVazaoAfluente(sistema.getNos(), intervalos, numUsina);
		...
		// gravarProdutividadeMediaAcumulada(sistema.getNos(), intervalos,
		// numUsina);
		arq.close();
	}

	public void gravarValorAgua(SimulacaoOperacaoEnergetica sistema, int intervalos, int numUsina) {
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Valor Agua Usina %d ------+%n", i + 1);

			for (int j = 0; j < intervalos; j++) {
				gravarArq.printf("%.10f", sistema.getValorAgua()[i * 60 + j]);
				gravarArq.println("");
			}
		}
	}
	...
	public void gravarVolumeMedio(NoHidroenergetico[][] volumeMedio, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- volume Medio Usina %d------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarVolumeInicial(NoHidroenergetico[][] volumeInicial, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- volume Inicial Usina %d------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarNivelMontante(NoHidroenergetico[][] volumeInicial, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- nivel montante Usina %d------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarNivelJusante(NoHidroenergetico[][] volumeInicial, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- nivel jusante Usina %d------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarVazaoDefluente(NoHidroenergetico[][] vazaoDefluente, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- vazao Defluente Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarVazaoAfluente(NoHidroenergetico[][] vazaoAfluente, int intervalos, int numUsina) {

		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- vazao Afluente Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
				gravarArq.printf("%.10f", vazaoAfluente[j][i].getVazaoAfluente());
				gravarArq.println("");
			}
	...
	public void gravarVolumefinal(NoHidroenergetico[][] volumeFinal, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- volume Final Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarEngolimentoMaximo(NoHidroenergetico[][] EngolimentoMaximo, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Engolimento Maximo Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarLimiteMaximoVazaoTurbinada(NoHidroenergetico[][] LimiteMaximoVazaoTurbinada, int intervalos,
			int numUsina) {

		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Limite Maximo Vazao Turbinada Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarVazaoTurbinada(NoHidroenergetico[][] VazaoTurbinada, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+-------  Vazao Turbinada Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarVazaoIncremental(NoHidroenergetico[][] AfluenciaIncremental, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+-------  Vazao Incremental Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarEnergiaArmazenadaNoSistema(HorizontePlanejamento EnergiaArmazenadaNoSistema, int intervalos,
			int numUsina) {
	...
	public void gravarGeracaoHidraulicaIndividual(NoHidroenergetico[][] GeracaoHidraulicaIndividual, int intervalos,
			int numUsina) {

		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- geracao Hidraulica  Usina %d  ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarGeracaoHidraulicaMaximaContinua(NoHidroenergetico[][] GeracaoHidraulicaMaximaContinua,
			int intervalos, int numUsina) {

		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- geracao Hidraulica Maxima Continua Usina %d  ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarAlturaDeQuedaLiquida(NoHidroenergetico[][] AlturaDeQuedaLiquida, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Altura De Queda Liquida Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarVazaoVertida(NoHidroenergetico[][] VazaoVertida, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Vazao Vertida  Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarPotenciaMaxima(NoHidroenergetico[][] PotenciaMaxima, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Potencia Maxima  Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarProdutividadeMedia(NoHidroenergetico[][] ProdutividadeMedia, int intervalos, int numUsina) {
		...
		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Produtividade Media Individual Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
	...
	public void gravarProdutividadeMediaAcumulada(NoHidroenergetico[][] ProdutividadeMediaAcumulada, int intervalos,
			int numUsina) {

		for (int i = 0; i < numUsina; i++) {
			gravarArq.printf("%n%n%n+------- Produtividade Media Acumulada Usina %d ------+%n", i + 1);
			for (int j = 0; j < intervalos; j++) {
